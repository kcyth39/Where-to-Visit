...
| S2 | 表示名の入力タイミング | 決定済（[ADR-0004](0004-permission-model.md)）— **入力は任意**（候補追加フォームの任意欄。2026-07-09 緩和。旧「参加時に入力」を撤回） |
...
> **全項目決着済み（2026-07-08）。** 新たな論点が出たら本リストに追記する。
