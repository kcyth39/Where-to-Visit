...
| N2 | 却下未満の懸念表明手段 | 決定済（[ADR-0007](0007-event-views-and-criterion-feedback.md)）— 判断基準ごとの🌀＝非決定のネガ懸念。同じ基準の❤️と両立可 |
...
| S2 | 表示名の入力タイミング | 決定済（[ADR-0006](0006-collaborative-response-row-model.md)・[ADR-0007](0007-event-views-and-criterion-feedback.md)）— オーナー初期セットアップまたはゲスト名前選択で非IME Enter / モバイル完了 / 通常blur時に確定。トップ・候補追加フォームには置かない |
