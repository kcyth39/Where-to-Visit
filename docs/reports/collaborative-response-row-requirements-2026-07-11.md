...
| CR-8.4 編集内容 | **Given** 候補編集 **When** 表示 **Then** Candidate情報上部で選択中回答者の○/−/×・判断基準別❤️/🌀を操作し、直下でコメントを保存できる |
...
| CR-8.12 詳細編集 | **Given** 候補編集 **When** 詳細を変更 **Then** 候補情報編集・判断基準編集・判断者編集の3menuを一覧下に置き、判断者編集は選択中回答者だけを扱う |
