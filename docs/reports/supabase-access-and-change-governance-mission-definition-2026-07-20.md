...
| SD-11 | ミッションと導入段階の開始承認 | 本書はproposalであり、GitHub／Supabase設定とcredential調査は別authorityを要する | 承認／修正要求／保留 | 次のExecution Contract作成可否を決める |
...
- [ ] Humanが本ミッションのGoal、scope、対象外、責任分担、risk境界を承認している。
