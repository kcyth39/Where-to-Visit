...
- [ ] オーナー初期セットアップに3ステップのタイトルと確定説明文が表示される
- [ ] オーナーは名前確定後も同じ画面でCandidate追加とURL共有へ続ける
- [ ] owner URLによる再訪は回答者未選択でも候補一覧を表示し、3ステップを再表示しない
