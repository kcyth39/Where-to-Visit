...
- ❤️（価格・属性別）と🌀（懸念）は非決定・意見可視化。確定判定に影響しない。
...
- 属性: 食事 / 宿泊 / アクティビティ / そのた
- 有効❤️: 食事(price/taste/facility/place)、宿泊(price/facility/place)、アクティビティ(price/interest)、そのた(interest)。🌀は全属性。
...
- In: お題作成・候補管理・総合評価・確定候補/イシュー化・❤️/🌀・コメント・URLコピー・マイイベント一覧(Cookie)・広告実装・オーナー編集URL・noindex・無期限保存・モバイル/デスクトップ同格。
